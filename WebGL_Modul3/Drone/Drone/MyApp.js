...
class MyApp {
    ...
    start() {
        ...
        // Kubemann:
        this.drone = new Drone(this.gl, this.camera);
        ...
        this.gl.clearColor(1, 1, 1, 1.0); //RGBA
    ...
    handleKeys(elapsed) {
        ...
        this.drone.handleKeys(elapsed, this.currentlyPressedKeys);
    }
    ...
    draw(currentTime) {
        ...
        this.drone.draw(elapsed, modelMatrix2);
